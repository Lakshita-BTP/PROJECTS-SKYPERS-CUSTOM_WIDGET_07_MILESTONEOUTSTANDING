(function () {
  class MilestoneOutstanding extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      const availableRowsHeight = canvasHeight - y - footerReservedHeight;
      const visibleRows = Math.max(
        1,
        Math.floor((availableRowsHeight - 10) / rowHeight),
      );
      ...
      if (totalRows > visibleRows) {
        const trackHeight = availableRowsHeight;
      ...
      const footerY = canvasHeight - footerReservedHeight + 10;
