(function () {
  class MilestoneOutstanding extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      const footerReservedHeight = 180;
      ...
      const visibleRows = Math.max(
        1,
        Math.floor((availableRowsHeight - tableHeaderHeight - 10) / rowHeight),
      );
      ...
      ctx.fillText("INVOICED", width * 0.40, y + 25);
      ...
      data.slice(0, visibleRows).forEach((item) => {
        ...
        ctx.fillText(this.formatRowValue(item.invoiced), width * 0.40, y + 24);
      ...
      const footerY = canvasHeight - footerReservedHeight + 20;
