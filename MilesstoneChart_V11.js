(function () {
  class MilestoneOutstanding extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      ctx.fillText("INVOICED", width * 0.48, y + 25);
      ctx.fillText("OUTSTANDING", width * 0.65, y + 25);
      ...
      data.slice(0, visibleRows).forEach((item) => {
        ...
        ctx.fillText(this.formatRowValue(item.invoiced), width * 0.48, y + 24);
      ...
      const footerY = canvasHeight - 125;
